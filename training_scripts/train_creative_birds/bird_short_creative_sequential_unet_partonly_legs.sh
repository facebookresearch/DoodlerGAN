...
#!/bin/bash
#SBATCH --job-name=short_bird_creative_legs_unet
#SBATCH --output=../../../jobs/sample-short_bird_creative_legs-%j.out
#SBATCH --error=../../../jobs/sample-short_bird_creative_legs-%j.err
