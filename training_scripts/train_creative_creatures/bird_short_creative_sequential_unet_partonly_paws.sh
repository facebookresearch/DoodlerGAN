...
#!/bin/bash
#SBATCH --job-name=long_generic_creative_paws_unet
#SBATCH --output=../../../jobs/sample-long_generic_creative_paws-%j.out
#SBATCH --error=../../../jobs/sample-long_generic_creative_paws-%j.err
