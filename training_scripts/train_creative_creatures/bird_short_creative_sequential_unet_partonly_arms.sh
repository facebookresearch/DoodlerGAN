...
#!/bin/bash
#SBATCH --job-name=long_generic_creative_arms_unet
#SBATCH --output=../../../jobs/sample-long_generic_creative_arms-%j.out
#SBATCH --error=../../../jobs/sample-long_generic_creative_arms-%j.err
