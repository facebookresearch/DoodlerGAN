...
#!/bin/bash
#SBATCH --job-name=long_generic_creative_tail_unet
#SBATCH --output=../../../jobs/sample-long_generic_creative_tail-%j.out
#SBATCH --error=../../../jobs/sample-long_generic_creative_tail-%j.err
