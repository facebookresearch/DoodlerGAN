...
#!/bin/bash
#SBATCH --job-name=long_generic_creative_body_unet
#SBATCH --output=../../../jobs/sample-long_generic_creative_body-%j.out
#SBATCH --error=../../../jobs/sample-long_generic_creative_body-%j.err
